...
# create a function to do sampling
  ...
  csvFile <- c("C:\\Project\\", "googleplaystore.csv") #Prepare vector to read csv file
  ...
  #Set Installs as the target predicting variables
  svmOutput <- ksvm(Installs~., data = trainData,kernel = "rbfdot",  C = 100,cross =10,prob.model = TRUE)
...
D9 <- D
#
colnames(D9) <- c("App","Category","Rating", "Reviews", "Size", "Installs", "Type", "Price", "ContentRating", "Genres", "LastUpdated", "CurrentVer", "AndroidVer","UpdateYear")
...
summary(m8)
#
# Model 9: Predict Installs from Reviews
m9 <- lm(formula = Installs ~ Reviews, data=D9)
# Display the regression analysis summary for Model 9:
summary(m9)
#
# Model 10: Predict Installs from Rating
m10 <- lm(formula = Installs ~ Rating, data=D9)
# Display the regression analysis summary for Model 10:
summary(m10)
#
# Model 11: Predict NetWorth from Installs
m11 <- lm(formula = TotalWorth ~ Installs, data=D9)
# Display the regression analysis summary for Model 11:
summary(m11)
#
